...
/**
 Tells the delegate a date in the calendar is selected by long press.
 */
- (void)calendar:(FSCalendar *)calendar longPressOnDate:(NSDate *)date atMonthPosition:(FSCalendarMonthPosition)monthPosition;
